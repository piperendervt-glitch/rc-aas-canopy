"""
run_v17_grid_search.py
v17実験（E1-medium）：0.3刻みグリッドサーチ

{0.1, 0.3, 0.5, 0.7}^3 = 64点の全組み合わせ
各値は双方向ペアに対応：[1↔2, 2↔3, 1↔3]
v12と同じgenerate_tasks()で100問実験
"""
...
def main():
    ...
    output_path = RESULTS_DIR / "v17_grid_search.jsonl"
    all_results = []
    start_all = time.time()
    ...
    print()
    print("=" * 70)
    print("v17実験 グリッドサーチ結果")
    print("=" * 70)

    print(f"\n--- 上位10 ---")
    print(f"  {'ID':<20} {'1-2':<6} {'2-3':<6} {'1-3':<6} {'acc':<8} {'warn'}")
    print("-" * 60)
    for r in sorted_results[:10]:
        print(f"  {r['pattern_id']:<18} {r['v12']:<6} {r['v23']:<6} {r['v13']:<6} "
